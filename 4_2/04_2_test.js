/*Как известно, в js не существует способа проверить идентичность объектов.
 ...
 Несмотря на то, что свойства в objB перемешаны
 ...
 вашна последовательность элементов, то есть массивы: `[1,2,3,4]` и `[2,1,3,4]` не равны,
...
console.log(deepEqual(objA, objB) ? 'Объекты равны' : 'Объекты не равны');